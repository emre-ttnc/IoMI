...
namespace IoMI.Persistence.Migrations
{
    ...
    [Migration("20221027203307_mig4_fix-gas-meter-applications")]
    partial class mig4_fixgasmeterapplications
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IoMI.Domain.Entities.ApplicationEntities.GasMeterInspectionApplication", b =>
                {
                    ...
                    b.ToTable("GasMeterInspectionApplications");
                });

            modelBuilder.Entity("IoMI.Domain.Entities.ApplicationEntities.ScaleInspectionApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ScaleInspectionApplications");
                });
            ...
            modelBuilder.Entity("ScaleScaleInspectionApplication", b =>
                {
                    b.Property<Guid>("InspectionApplicationsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ScalesId")
                        .HasColumnType("uuid");

                    b.HasKey("InspectionApplicationsId", "ScalesId");

                    b.HasIndex("ScalesId");

                    b.ToTable("ScaleScaleInspectionApplication");
                });
            ...
            modelBuilder.Entity("ScaleScaleInspectionApplication", b =>
                {
                    b.HasOne("IoMI.Domain.Entities.ApplicationEntities.ScaleInspectionApplication", null)
                        .WithMany()
                        .HasForeignKey("InspectionApplicationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
